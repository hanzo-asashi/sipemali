...
return [
    ...
    */
    ...
    'features' => [
        ...
        'database' => [
            ...
            'slow_threshold' => env('CLOCKWORK_DATABASE_SLOW_THRESHOLD', true),

            // Collect only slow database queries
            'slow_only' => env('CLOCKWORK_DATABASE_SLOW_ONLY', true),
    ...
    */
    ...
    'requests' => [
        ...
        'slow_threshold' => env('CLOCKWORK_REQUESTS_SLOW_THRESHOLD', true),

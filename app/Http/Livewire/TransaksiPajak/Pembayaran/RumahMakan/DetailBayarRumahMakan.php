...
class DetailBayarRumahMakan extends Component
{
    public $pembayaran;
    public $objekpajak;
...
//    public function tambahBayar(Pembayaran $pembayaran)
//    {
//        $this->showModalBayar = true;
//        $this->pembayaran = $pembayaran;
//        $this->no_transaksi = Helper::generateNoTransaksi();
//        $this->wajib_pajak_id = $this->pembayaran->wajib_pajak_id;
//        $this->objek_pajak_id = $this->pembayaran->objek_pajak_id;
//        $this->bulan = $this->pembayaran->bulan;
...
//        $this->openModal(['pembayaran' => $pembayaran]);
//        $this->resetInput();
//    }

    private function resetInput()
    {
        $this->reset('nilai_pajak', 'tahun', 'bulan', 'status_bayar', 'jumlah_bayar', 'keterangan', 'metode_bayar');
    }
...
//            $value = (double) $value;
//        } else {
//            $value = (double) Str::replace($value, '.', '');
//        }
//        $this->nilai_pajak = (double) Str::replace($this->nilai_pajak, '.', '');
...
//        $validatedData['bulan'] = $this->state['bulan'] ?: $this->pembayaran->tahun;
        ...
        $validatedData['no_transaksi'] = $noTransaksi;
...
//            $bayar = Pembayaran::create($values);
    ...
    public function deletePembayaran(Pembayaran $pembayaran)
    {
        if ($pembayaran->delete()) {
            $this->alert([
                'success' => true,
                'message' => 'Pembayaran objek pajak berhasil dihapus',
            ]);
        } else {
            $this->alert([
                'success' => false,
                'message' => 'Pembayaran objek pajak gagal dihapus',
            ]);
        }
    }
    ...
    public function render()
    {
        ...
        return view('livewire.transaksi-pajak.pembayaran.rumah-makan.detail-bayar-rumah-makan',

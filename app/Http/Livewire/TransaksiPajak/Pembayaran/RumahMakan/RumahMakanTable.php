...
class RumahMakanTable extends Component
{
    use WithPagination;
...
//    public bool $lockButton = false;
    ...
    public function mount($id, ObjekPajak $objekPajak)
    {
...
//
        ...
        if ($create) {
            ...
            $this->closeModal();
            $this->resetInput();
            $this->redirectRoute('pembayaran.rumahmakan.detail', $this->objekPajak->id);
        } else {
            $this->alert([
                'success' => false,
...
//            ->groupBy('id_jenis_op')
        ...
        return view('livewire.transaksi-pajak.pembayaran.rumah-makan.table', compact('listPembayaran',
            'listMetodeBayar', 'listBulan', 'listTahun', 'listStatus'));
    }
}

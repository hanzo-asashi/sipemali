<div class="modal fade" id="modal-bayar-ppj" tabindex="-1" aria-labelledby="modalBayarPpj" aria-hidden="true" wire:ignore.self>
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalBayarPpj">
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-3">
                            ...
                            <div class="input-group">
                                <input wire:model.lazy="state.besaran_kwh"
                                       type="number" class="form-control @error('besaran_kwh') is-invalid @enderror"
                                       placeholder="" id="besaran_kwh">
                        ...
                        <div class="mb-3 col-md-4">
                            <label for="harga_satuan_kwh" class="form-label">Harga Per KWH</label>
                            <div class="input-group">
                                <span class="input-group-text">Rp.</span>
                                <input wire:model.lazy="state.harga_satuan_kwh"
                                       type="text" class="form-control @error('harga_satuan_kwh') is-invalid @enderror"
                                       placeholder="" id="harga_satuan_kwh">
                                @error('harga_satuan_kwh')
                                <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input wire:model.lazy="state.nilai_pajak"
                                       type="text" class="form-control @error('state.nilai_pajak') is-invalid @enderror"

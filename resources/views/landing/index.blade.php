...
{{--                            <img style="width: 80px;height: 80px;" src="{{ asset('assets/images/logo/logo-cutout.png') }}" alt=""/>--}}
            ...
            <div class="container-fluid">
                <div class="row mt-3">
                    <div id="vanta" class="col-xl-8 bg-gradient bg-soft-light bg-card-img">
                        <div class="text-center text-white p-4 pt-5">
                            ...
                            <div>
                                ...
                                @endauth
                                @guest()
                                    <a href="{{ route('login') }}" class="btn btn-info mt-2 me-2 waves-effect waves-light">Login Sistem</a>
                                @endguest
                    ...
                    <div class="col-xl-4 bg-gradient bg-info">
            ...
            <div class="bg-warning pt-5 pb-4 px-5">
                <div class="row">
                    <div class="col-xl-3">
                        <div class="card">
                            <div class="card-body overflow-hidden position-relative">
                                ...
                                <h5 class="mt-3">SEMUA PELANGGAN</h5>
                                <h3 class="mt-3 mb-0">{{ $data['totalSemuaPelanggan'] }} <span style="font-size: 13px; font-style: italic;">Orang</span></h3>
                            </div>
                            <!-- end card body -->
                        </div>
                        <!-- end card -->
                    ...
                    <div class="col-xl-3">
                        <div class="card">
                            <div class="card-body overflow-hidden position-relative">
                                ...
                                <h3 class="mt-3 mb-0">{{ $data['totalPelangganAktif'] }} <span style="font-size: 13px; font-style: italic;">Orang</span></h3>
                            </div>
                            <!-- end card body -->
                        </div>
                        <!-- end card -->
                    ...
                    <div class="col-xl-3">
                        <div class="card">
                            <div class="card-body overflow-hidden position-relative">
                                ...
                                <h3 class="mt-3 mb-0">{{ $data['totalPelangganValid'] }}&nbsp; &nbsp;<span style="font-size: 13px; font-style: italic;">Orang</span></h3>
                            </div>
                            <!-- end card body -->
                        </div>
                        <!-- end card -->
                    ...
                    <div class="col-xl-3">
                        <div class="card">
                            <div class="card-body overflow-hidden position-relative">
                                ...
                                <h3 class="mt-3 mb-0"><span style="font-size: 13px; font-style: italic;">Rp.</span> {{ number_format($data['totalTertunggak'],0,',','.') }}</h3>
                            </div>
                            <!-- end card body -->
                        </div>
                        <!-- end card -->

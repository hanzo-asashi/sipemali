                ...
                <div class="table-responsive">
                    <table class="table table-responsive table-hover table-bordered">
                        ...
                        @forelse($listCustomers as $cust)
                            <tr class="@if($this->isChecked($cust->id)) bg-light @endif text-center">
                                <td>
                                    <div class="form-check">
                                ...
                                <td>
                                    <span class="badge rounded-pill badge-light-{{ \App\Utilities\Helpers::setBadgeColor($cust->status_pelanggan) }} me-1">
                                        {{ isset($cust->statusPelanggan) ? $cust->statusPelanggan->nama_status : '-' }}
                                    </span>
                                </td>
                                <td>
                                     <span class="badge rounded-pill badge-light-{{ $cust->is_valid ? 'success' : 'danger' }} me-1">
                                        {!! $cust->is_valid ? '<i class="far fa-check-circle"></i>' : '<i class="fa fa-check-circle"></i>'  !!}
                                    </span>
                                </td>
                                <td>

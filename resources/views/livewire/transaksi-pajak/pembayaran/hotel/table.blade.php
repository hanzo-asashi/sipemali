<div>
    @section('title') Pembayaran Hotel @endsection
    @push('css')
        <link href="{{ asset('assets/libs/flatpickr/flatpickr.min.css') }}" rel="stylesheet" type="text/css"/>
    @endpush
    <x-breadcrumb>
        <x-slot name="li_1">Dashboard</x-slot>
        <x-slot name="title">Pembayaran Hotel</x-slot>
    </x-breadcrumb>
    <div class="content-header row">
        <div class="content-body">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="mb-3">
                        <h5 class="card-title">Semua Hotel <span class="text-muted fw-normal ms-2">({{ $listObjekPajak->count() }})</span>
                        </h5>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            ...
                            <div class="row">
                                ...
                                {{--                        <div class="col-md-2">--}}
                                {{--                            <div wire:ignore>--}}
                                {{--                                <label class="form-label" for="bulan">Filter Berdasarkan Masa</label>--}}
                    ...
                    <x-table.table-body>
                        @forelse($listPembayaran as $op)
                            @php
                                ...
                                if($pembayaran->get()->count() > 0){
                                    $qryBln = $pembayaran->get()->first();
                                }else{
                                    $qryBln = null;
                                }
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        <div class="btn-group">
                                            ...
                                            @can('detail pembayaran')
                                                <a id="{{ $op->id }}" href="{{ route('pembayaran.hotel.detail', $op->id) }}"

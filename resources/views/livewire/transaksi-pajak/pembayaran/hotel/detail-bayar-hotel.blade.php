    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card border-0">
                <div class="col-md-3">
                    <a href="{{ route('pembayaran.hotel', $objekpajak->id_jenis_op) }}" class="btn btn-sm btn-label btn-link btn-light">
                                    ...
                                    <td style="width: 2%;">
                                        <div wire:ignore class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end" style="">
                                                ...
                                                <li>
                                                    <a href="{{ route('laporan-pajak.bukticetak',['page' => 'sts', 'bayarid' => $bayar->id]) }}" target="_blank" type="button"
                                                       class="dropdown-item">

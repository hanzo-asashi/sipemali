    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card border-0">
                <div class="col-md-3">
                    <a href="{{ route('pembayaran.rumahmakan', $objekpajak->id_jenis_op) }}" class="btn btn-sm btn-label btn-link btn-light">
        ...
        <div class="content-body">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="datatable" class="table table-bordered table-responsive table-check nowrap font-size-14" style="width: 100%;">
                            ...
                            @forelse($objekpajak->pembayaran()->get() as $bayar)
                                <tr wire:key="{{ $bayar->id }}">
                                    ...
                                    <td>{{ money($bayar->jumlah_bayar ?: 0,'IDR', true) }} </td>
                                    ...
                                    <td style="width: 2%;">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end" style="">
                                                ...
                                                <li>
                                                    <button type="button" wire:click.prevent="deletePembayaran({{ $bayar }})" class="dropdown-item">
                                                        <i class="bx bx-trash font-size-16 align-middle me-2"></i> Hapus Pembayaran
                                                    </button>
                                                </li>
                                                <li>

    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card border-0">
                <div class="col-md-3">
                    <a href="{{ route('pembayaran.peneranganjalanumum', $objekpajak->id_jenis_op) }}" class="btn btn-sm btn-label btn-link btn-light">
                       ...
                       <table id="datatable" class="table table-responsive table-bordered table-check nowrap font-size-14" style="width: 100%;">
                           ...
                           @forelse($objekpajak->pembayaran()->get() as $bayar)
                               <tr wire:key="{{ $bayar->id }}">
                                   ...
                                   <td>{{ !is_null($bayar->updated_at) ? $bayar->updated_at->format('d/m/Y') : '-' }}</td>
                                           ...
                                           <ul class="dropdown-menu dropdown-menu-end" style="">
                                               <li>
                                                   <a class="dropdown-item" href="#" data-bs-toggle="tooltip"
                                                      data-bs-placement="top" title="Ubah Pembayaran"
                                               ...
                                               <li>
                                                   <button class="dropdown-item" data-bs-toggle="tooltip"
                                                      data-bs-placement="top" title="Hapus Pembayaran"
                                                      wire:click.prevent="deletePembayaran({{ $bayar->id }})">

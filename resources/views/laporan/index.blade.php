        		...
        		<div class="col-lg-4">
		            <div class="card">
		                <div class="card-body">
		                    ...
		                    <a href="{{ route('laporan.realisasi') }}" class="btn btn-primary">Lihat Laporan</a>
		                </div>
		            </div>
		        </div>
        		<div class="col-lg-4">
		            <div class="card">
		                <div class="card-body">
		                    ...
		                    <a href="{{ route('laporan.jenispajak') }}" class="btn btn-primary">Lihat Laporan</a>
		                </div>
		            </div>
		        </div>
        		<div class="col-lg-4">
		            <div class="card">
		                <div class="card-body">
		                    ...
		                    <a href="{{ route('laporan.wilayah') }}" class="btn btn-primary">Lihat Laporan</a>
		                </div>
		            </div>
		        </div>
        		<div class="col-lg-4">
		            <div class="card">
		                <div class="card-body">
		                    ...
		                    <a href="{{ route('laporan.metodebayar') }}" class="btn btn-primary">Lihat Laporan</a>
		                </div>
		            </div>
		        </div>
        		<div class="col-lg-4">
		            <div class="card">
		                <div class="card-body">
		                    ...
		                    <a href="{{ route('laporan.realisasiopd') }}" class="btn btn-primary">Lihat Laporan</a>
		                </div>
		            </div>
		        </div>
        		<div class="col-lg-4">
		            <div class="card">
		                <div class="card-body">
		                    ...
		                    <a href="{{ route('laporan.belanjaopd') }}" class="btn btn-primary">Lihat Laporan</a>
		                </div>
		            </div>
		        </div>
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ route('laporan.tambangmineral') }}" class="btn btn-primary">Lihat Laporan</a>
                        </div>
                    </div>
                </div>
        	</div>

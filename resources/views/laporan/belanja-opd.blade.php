    ...
    <div class="content-header">
        <div class="card bg-soft-light border-secondary">
            <div class="card-body p-2">
                <div class="row">
                    <div class="col-md-8">
                        <form action="{{ route('laporan.belanjaopd') }}">
...
{{--                            <div>--}}
{{--                                <a href="{{ route('laporan.preview', ['page' => $page, 'periode' => $periode,'opd' => $filterOpd]) }}" target="_blank" class="btn btn-soft-primary btn-lg--}}
{{--                                mt-1">--}}

    ...
    <div class="content-header">
        <div class="card bg-soft-light border-secondary">
            <div class="card-body p-2">
                <div class="row">
                    <div class="col-md-8">
                        <form action="{{ route('laporan.wilayah') }}">
                    ...
                    <div class="col-md-4">
                        @include('laporan.partial.action', ['page' => $page, 'periode' => $periode,'kecamatan' => $filterKecamatan, 'bulan' => $filterBulan])
{{--                        <div class="d-flex flex-wrap align-items-center justify-content-end gap-1">--}}
{{--                            <div>--}}
{{--                                <a href="--}}
{{--                                    {{ route('laporan.preview', ['page' => $page, 'periode' => $periode,--}}
